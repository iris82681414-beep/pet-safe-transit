...
const { user, avatar, vehicles, transitCount, pendingAlertCount, unreadCount, notifications } = storeToRefs(store)
...
const menus = [
  ...
  { key: 'warehouse', label: '仓库管理', icon: 'Box', roles: ['WAREHOUSE', 'ADMIN'] },
